...
public class DiscountCurveDemo {
    ...
    private static void discountCurve() {
        ...
        System.out.println("等价 Zero Rate："+ equZero);
        System.out.println("等价 Zero Rate 计算的贴现因子："+ equZero.discountFactor(settlement, tmpDate1));
        System.out.println("真实 Discount Factor："+ curve.discount(tmpDate1));
        System.out.println("1Y3M-1Y6M 间的远期收益率 Fwd Rate："+ curve.forwardRate(tmpDate1, tmpDate2, dc, Compounding.Continuous));
    }
}
