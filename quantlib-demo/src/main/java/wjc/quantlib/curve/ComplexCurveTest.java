...
public class ComplexCurveTest {
    ...
    public void testComplexCurve() {
        ...
        List<FixedRateBondHelper> helpers = new ArrayList<>();
        ...
        for (int i = 0; i < instruments.size(); i++) {
            ...
            Leg cfs = helpers.get(i).bond().cashflows();
        ...
        Array a1 = ts1.fitResults().solution();
        for (int i = 0; i < a1.size(); i++) {
            System.out.println(String.format("%-+20.10f", a1.get(i)));
        }
